...
AFRAME.registerComponent("markerhandler", {
  ...
  getDistance: function (modelA, modelB) {
        return modelA.object3D.position.distanceTo(modelB.object3D.position);
  },

  // Checking if model is presnt in the array
